...
% Give the line-breaker room to avoid forcing a tight, badly-overfull line
% when a long compound word (e.g. "microcontroller-class") has only one
% internal hyphen to break at. This does not change wording or meaning —
% it only lets already-hyphenatable lines use looser interword spacing
...
\begin{table}[H]
    ...
    \begin{tabular}{>{\raggedright\arraybackslash}p{3.3cm} >{\raggedright\arraybackslash}p{2.1cm} >{\raggedright\arraybackslash}p{1.5cm} >{\centering\arraybackslash}p{1.7cm} >{\centering\arraybackslash}p{1.9cm}}
        \toprule
...
\footnotesize
\setlength{\tabcolsep}{4pt}
\begin{longtable}{ll l >{\raggedright\arraybackslash}p{2.3cm} >{\raggedleft\arraybackslash}p{1.6cm} >{\raggedleft\arraybackslash}p{1.5cm} >{\raggedleft\arraybackslash}p{1.5cm}}
...
\begin{longtable}{ll >{\raggedright\arraybackslash}p{3.7cm} >{\raggedleft\arraybackslash}p{1.6cm} >{\raggedleft\arraybackslash}p{1.7cm} >{\raggedleft\arraybackslash}p{1.3cm}}
...
\footnotesize
\setlength{\tabcolsep}{3pt}
\begin{longtable}{ll >{\raggedright\arraybackslash}p{2.9cm} >{\raggedleft\arraybackslash}p{1.15cm} >{\raggedleft\arraybackslash}p{1.15cm} >{\centering\arraybackslash}p{1.5cm} >{\raggedleft\arraybackslash}p{1.05cm} >{\raggedleft\arraybackslash}p{1.15cm}}
...
\footnotesize
\setlength{\tabcolsep}{3pt}
\begin{longtable}{ll >{\raggedright\arraybackslash}p{3.4cm} >{\raggedleft\arraybackslash}p{1.15cm} >{\raggedleft\arraybackslash}p{1.15cm} >{\centering\arraybackslash}p{1.5cm} >{\raggedleft\arraybackslash}p{1.05cm}}
